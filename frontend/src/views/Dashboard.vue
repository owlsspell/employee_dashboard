...
<template class="bg-base-200">
  <div class="h-full grid grid-cols-1 gap-4 m-5 md:grid-cols-2 max-h-[600px]">
    <div
      class="p-4 border border-base-300 rounded-lg shadow-sm col-span-1 sm:p-6 h-[600px] shadow-lg"
    >
      <ChartPie />
    </div>
    <div
    ...
    <div
      class="p-4 border border-base-300 rounded-lg shadow-sm md:col-span-2 sm:p-6 h-[600px] shadow-lg"
    >
      <WorldMap />
    </div>
  </div>
